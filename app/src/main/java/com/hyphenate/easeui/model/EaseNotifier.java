...
public class EaseNotifier {
     ...
     * @param message
     */
    public synchronized void onNewMsg(EMMessage message, boolean forceNotify) {
        ...
        if (!EasyUtils.isAppRunningForeground(appContext) || forceNotify) {
