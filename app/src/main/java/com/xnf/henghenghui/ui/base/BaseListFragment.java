...
import com.xnf.henghenghui.cache.CacheManager;
import com.xnf.henghenghui.model.Entity;
import com.xnf.henghenghui.model.ListEntity;
import com.xnf.henghenghui.ui.adapter.ListBaseAdapter;
...
@SuppressLint("NewApi")
public abstract class BaseListFragment<T extends Entity> extends BaseFragment2
    ...
    private boolean onTimeRefresh() {
        String lastRefreshTime = HengHengHuiAppliation.getLastRefreshTime(getCacheKey());
    ...
    protected AsyncHttpResponseHandler mHandler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int statusCode, Header[] headers,
            ...
            if (mCurrentPage == 0 && needAutoRefresh()) {
                HengHengHuiAppliation.putToLastRefreshTime(getCacheKey(),
...
//        }
    ...
    protected int getPageSize() {
        return HengHengHuiAppliation.PAGE_SIZE;
    }
...
//            }
    ...
    protected void saveToReadedList(final View view, final String prefFileName,
            final String key) {
        // 放入已读列表
        HengHengHuiAppliation.putReadedPostList(prefFileName, key, "true");
        TextView tvTitle = (TextView) view.findViewById(R.id.tv_title);
        if (tvTitle != null) {
            tvTitle.setTextColor(HengHengHuiAppliation.getInstance().getResources().getColor(R.color.day_infoTextColor));
        }
    }
}
