...
public class AnswerDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static final String TYPE = "AnswerDetailActivity";
    ...
    protected void initView() {
        ...
        mAnimation = AnimationUtils.loadAnimation(AnswerDetailActivity.this, R.anim.nn);
            ...
            case CodeUtil.CmdCode.MsgTypeCode.MSG_CLASS_COURSE_FAV_OPT:{
                ...
                if(Utils.getRequestStatus(response1) == 1) {
                    ...
                    if (httpCommitQaResponse.getResponse().getSucceed() == 1) {
                        ToastUtil.showToast(AnswerDetailActivity.this,getString(R.string.op_success));
                        if (!mIsFav) {
                            mIsFav = true;
                        ...
                        ToastUtil.showToast(AnswerDetailActivity.this,getString(R.string.op_failed,
    ...
    public void handleShare() {
        ...
        if(mHttpArticleResponse!=null){
            ...
            dialog.setShareInfo(mHttpArticleResponse.getResponse().getContent().getArttitle(),
                    mHttpArticleResponse.getResponse().getContent().getArtcontent().substring(0,100), Urls.SHARE_ARTICLE_URL+mArticleId);
        }else{
            dialog.setShareInfo("哼哼会",
                    "", Urls.SHARE_ARTICLE_URL+mArticleId);
        }
        dialog.show();
    }
