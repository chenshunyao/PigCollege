...
public class NotificationListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static final String TYPE = "NotificationListActivity";
    ...
    protected void initView() {
        ...
        mAdapter = new CommentListAdapter(NotificationListActivity.this);
...
//                    }
    ...
    private void addData() {
        ...
        if(mRequestNum >= mTotalComments){
            Toast.makeText(NotificationListActivity.this, "没有更多内容了", Toast.LENGTH_SHORT).show();
            return;
        }
        else{
            //CourseManager.requestCommentList(LoginUserBean.getInstance().getLoginUserid(),mStartIndex,mRequestNum,mHandler);
    ...
    private class CommentListAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(comment.getUserPhoto()!=null && !comment.getUserPhoto().isEmpty()){
                Picasso.with(NotificationListActivity.this).load(comment.getUserPhoto()).error(R.drawable.index_zhuanti).
