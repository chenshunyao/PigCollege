...
//    private EditText mDetail;
    ...
    protected void initData() {
        currQaType = getIntent().getStringExtra("type");
        currDetail = getIntent().getStringExtra("detail");
        currImgs = getIntent().getStringArrayListExtra("imgs");
        initDialog();
    }
    ...
    protected void initView() {
        ...
        mRightTxt.setText(R.string.main_hengheng_qa_commit);
...
//        mDetail = (EditText)findViewById(R.id.edit_detail);
        mNum = (EditText)findViewById(R.id.edit_num);
        mAge = (EditText)findViewById(R.id.edit_age);
        mQa = (EditText)findViewById(R.id.edit_qa);
        mHistory = (EditText)findViewById(R.id.edit_history);
        mIll = (EditText)findViewById(R.id.edit_ill);
        mMedication = (EditText)findViewById(R.id.edit_medication);
...
//                break;
    ...
    private void initDialog(){
        dialog = new ProgressDialog(QA2Activity.this);
    ...
    private void commitQA(){
        if(currImgs.size() > 1){
            ...
            for(int i = 0;i < currImgs.size() - 1;i++){
                String str = currImgs.get(i);
            ...
            try {
                ...
                jsonObj.put("qtDesc", currDetail);
                jsonObj.put("fileMappingId", "");
                jsonObj.put("qtPhotos", "");
                inJsonObj.put("attackNum", mNum.getText().toString().trim());
                inJsonObj.put("days", mAge.getText().toString().trim());
                inJsonObj.put("temp", mQa.getText().toString().trim());
                inJsonObj.put("illnesses", mHistory.getText().toString().trim());
                inJsonObj.put("immune", mIll.getText().toString().trim());
                inJsonObj.put("medication", mMedication.getText().toString().trim());
            ...
            case CodeUtil.CmdCode.MsgTypeCode.MSG_COMMIT_QA: {
                ...
                if (Utils.getRequestStatus(response) == 1) {
                    ...
                    if(httpCommitQaResponse.getResponse().getSucceed() == 1){
                        ...
                        ToastUtil.showToast(QA2Activity.this,getString(R.string.op_success));
                        finish();
                    }else{
                        ToastUtil.showToast(QA2Activity.this,getString(R.string.op_failed,
...
//                            showPhotoDialog();
//                        }else{
//                            ToastUtil.showToast(QA2Activity.this,getString(R.string.error_most_img));
//                        }
//                    }
//                });
//            }
