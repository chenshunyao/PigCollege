...
import com.xnf.henghenghui.cityselection.MyLetterListView.OnTouchingLetterChangedListener;

public class CitySelectActivity extends Activity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(R.string.change_city_title);
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 2) {
                    setResult(allCity_lists.get(position).getName(),allCity_lists.get(position).getAreaCode().toString());
                }
            }
        });
        locateProcess = 1;
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                setResult(city_result.get(position).getName(),city_result.get(position).getAreaCode().toString());
            }
        });
        initOverlay();
        cityInit();
...
//        allCity_lists.add(city);
        City city = new City("热门", "0","0"); // 热门城市
        allCity_lists.add(city);
        city = new City("全部", "1","0"); // 全部城市
        allCity_lists.add(city);
    ...
    public void hotCityInit() {
        City city = new City("上海", "0","10");
        city_hot.add(city);
        city = new City("北京", "0","1");
        city_hot.add(city);
        city = new City("广州", "0","20");
        city_hot.add(city);
        city = new City("深圳", "0","30");
        city_hot.add(city);
        city = new City("武汉", "0","57");
        city_hot.add(city);
        city = new City("天津", "0","40");
        city_hot.add(city);
        city = new City("西安", "0","42");
        city_hot.add(city);
        city = new City("南京", "0","55");
        city_hot.add(city);
        city = new City("杭州", "0","50");
        city_hot.add(city);
        city = new City("成都", "0","59");
        city_hot.add(city);
        city = new City("重庆", "0","45");
        city_hot.add(city);
        if(getIntent().getBooleanExtra("showAll",false)){
            city = new City("全部城市", "0","0");
            city_hot.add(city);
        }
    }
           ...
           if (viewType == 0) {
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        setResult(city_hot.get(position).getName(),city_hot.get(position).getAreaCode().toString());
    ...
    private void setResult(String city,String code){
