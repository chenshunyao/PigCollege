...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // 数据库文件目标存放路径为系统默认位置
    private static String DB_PATH = "/data/data/com.xnf.henghenghui/databases/";
    /*
        ...
        if (dbExist) {
            ...
            try {
               ...
               // String outFileName = DB_PATH + DB_NAME;
                //copyFileFromAssets(myContext,ASSETS_NAME,outFileName);
            } catch (Exception e) {
    ...
    public static void copyFileFromAssets(Context context, String assetsFilePath, String targetFileFullPath) {
        ...
        InputStream assestsFileImputStream;
                try {
                      ...
                      L.d(TAG, "copyFileFromAssets " + "IOException-" + e.getMessage());
                       e.printStackTrace();
                    }
            }
    ...
    private void copyDataBase() throws IOException {
        ...
        //InputStream myInput = myContext.getResources().openRawResource(R.raw.cities);
        InputStream myInput = myContext.getClass().getClassLoader().getResourceAsStream("assets/"+ASSETS_NAME);
        // InputStream myInput = myContext.getResources().getAssets().open(ASSETS_NAME);
