...
import com.xnf.henghenghui.BaseApplication;
...
public class TDevice {
    ...
    public static boolean hasInternet() {
        boolean flag;
        if (((ConnectivityManager) HengHengHuiAppliation.context().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo() != null)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static void gotoMarket(Context context, String pck) {
        if (!isHaveMarket(context)) {
            HengHengHuiAppliation.showToast("你手机中没有安装应用市场！");
            return;
        }
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_VIEW);
    ...
    public static void copyTextToBoard(String string) {
        ...
        clip.setText(string);
//        HengHengHuiAppliation.showToast("Success");
    }
    ...
    public static int getNetworkType() {
        int netType = 0;
        ConnectivityManager connectivityManager = (ConnectivityManager) HengHengHuiAppliation
